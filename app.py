...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mssql+pyodbc://serverkaouthar:Kaouthar2001@cvappserveur.database.windows.net/serverkaouthar?driver=ODBC+Driver+17+for+SQL+Server'
db.init_app(app)
